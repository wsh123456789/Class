...
<html>
  ...
  <body>
<form action="${pageContext.request.contextPath }/customerAction_add"  name="form1" onsubmit="return validator(this)" method="post" >
    ...
    <tr>
		...
		<td colspan="3" bgcolor="#FFFFFF">
			<select name="customerType" style=" width: 145px">
				...
				<option  value="1">大款</option>
				<option  value="1">屌丝</option>
			</select>		
		</td>
    </tr>
	<tr>
	...
	<tr>
		...
		<td colspan="3" bgcolor="#FFFFFF">
			<select name="customerCondition" style=" width: 145px">
				<option  value="1">上钩</option>
				<option  value="2">没上钩</option>
			</select>		
		</td>
    </tr>
