...
public class PointProxy {
	...
	private void before(JoinPoint joinPoint)throws Exception {
        ...
        String newURL = requestURL.substring(requestURL.indexOf(context)+ context.length()+1,requestURL.length());
//        String newURL = requestURL.substring(requestURL.indexOf("localhost/")+ "localhost/".length(),requestURL.length());
