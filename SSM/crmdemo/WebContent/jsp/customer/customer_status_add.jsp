...
<body>
<form action="${pageContext.request.contextPath }/customer/customerCondition_add"  name="form4" onsubmit="return checkForm('form4');"  method="post" >
			<table class=editTable cellSpacing=1 cellPadding=0 width="100%"
				...
				<tr>
					...
					<td colspan="3" bgcolor="#FFFFFF">
						<input type="text"  maxlength="20"  name="conditionName" >
						&nbsp;
					</td>
				</tr>
				<tr>
					...
					<td colspan="3" bgcolor="#FFFFFF">
						<input type="text"  maxlength="20"  name="conditionExplain" >
						&nbsp;
					</td>
				</tr>
